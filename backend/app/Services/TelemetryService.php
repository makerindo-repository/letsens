...
class TelemetryService
{
    ...
    public function storeTelemetry(array $data): SensorLog
    {
        ...
        $log = SensorLog::create([
            ...
            'occupied' => $occupied,
            'soapLevelPercent' => (int) ($data['soap_level_percent'] ?? $data['soapLevelPercent'] ?? 80),
            'tissueLevelPercent' => (int) ($data['tissue_level_percent'] ?? $data['tissueLevelPercent'] ?? 80),
        ...
        if ($toilet) {
            $toilet->update([
                ...
                'occupied' => $occupied,
                'soap_level_percent' => (int) ($data['soap_level_percent'] ?? $data['soapLevelPercent'] ?? $toilet->soap_level_percent),
                'tissue_level_percent' => (int) ($data['tissue_level_percent'] ?? $data['tissueLevelPercent'] ?? $toilet->tissue_level_percent),
